/**
 * This class solves the N-Queens problem using a backtracking algorithm.
 * It finds all possible ways to place N queens on an NxN chessboard
...
public class NQueens {
    ...
    public static void main(String[] args) {
        n = 4; // Set the size of the chessboard (8x8 by default)
